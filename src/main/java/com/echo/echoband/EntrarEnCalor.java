...
public class EntrarEnCalor extends Application {
    public void cambiarEscena(Stage stage, String vistaFXML) throws IOException {
        ...
        scene.getStylesheets().add(getClass().getResource("entrarEnCalorStyle.css").toExternalForm());
    ...
    public void start(Stage stage) throws IOException {
        cambiarEscena(stage, "entrarEnCalorView.fxml");
