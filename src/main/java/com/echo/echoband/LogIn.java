...
public class LogIn extends Application {
    public void cambiarEscena(Stage stage, String vistaFXML) throws IOException {
        ...
        Image imagen = new Image(SignUp.class.getResource("/imgLogIn.jpg").toExternalForm());
        ...
        scene.getStylesheets().add(SignUp.class.getResource("logInStyle.css").toExternalForm());
